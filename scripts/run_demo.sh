...
# Run inside WSL Ubuntu 22.04. Requires PX4 SITL already running in another terminal:
#   cd ~/PX4-Autopilot && PX4_GZ_WORLD=baylands make px4_sitl gz_x500_gimbal
set -e

WS_ROOT="${WS_ROOT:-/mnt/d/2026CV/ros2_ws}"
...
View the annotated stream in another WSL terminal:
  source /opt/ros/humble/setup.bash
